    ...
    return (
        <div className='overflow-x-hidden'>
            ...
            <div className='padding  mt-20'>
                <div className='flex justify-center flex-wrap 2xl:flex-nowrap items-center gap-10 lg:items-start lg:justify-center'>
                    <div className='max-w-none text-2xl font-normal 2xl:max-w-[400px]'>
                        <h1>We Work Hard To Provide You The Best Quality Plants And Succulents</h1>
                    </div>
                    <div className=' max-w-[720px]'>
                        <p className='text-gray-600 text-[15px] text-center 2xl:text-start'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using.</p>
                        <div className='flex items-center justify-center mt-6 2xl:justify-start'>
                ...
                <div className='flex items-center justify-center flex-col mt-12 2xl:mt-56'>
                    ...
                    <div className='flex items-center justify-center gap-3 mt-9 w-[100%] flex-wrap 2xl:justify-between'>
                        <p className='text-gray-700 text-[15px] max-w-none text-center  2xl:max-w-[500px] 2xl:text-left'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using ‘Content here, content here’, making it look like readable English. Many desktop publishing packages and web page editors</p>
                        <p className='text-gray-700 text-[15px] max-w-none text-center  2xl:max-w-[500px] 2xl:text-left'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn’t anything embarrassing hidden in the middle of text. </p>
                    </div>
                </div>
                <div className='flex items-center justify-center flex-col mt-40 '>
                    <h1 className='text-4xl font-medium'>Our Company</h1>
                    <p className='text-center mt-5 max-w-[624px] text-gray-700 leading-[29px] '>I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo, when an unknown printer took a galley.</p>
                    <div className='flex items-center justify-between w-[100%] flex-wrap mt-20'>
